...
class BookingSummaryTabletLayout extends ConsumerWidget {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _summaryRow('Total Amount', '\$ \${totalAmount.toStringAsFixed(2)}', isTotal: true),
                  ],
                ),
              ),
              if (state.error != null) ...[
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: state.isLoading 
                      ? const SizedBox(height: 24, width: 24, child: CircularProgressIndicator(color: AppColors.background))
                      : Text('Confirm & Pay', style: AppTypography.button.copyWith(fontSize: 18)),
                ),
              ),
            ],
          ),
  ...
  Widget _summaryRow(String label, String value, {bool isTotal = false}) {
    return Row(
      ...
      children: [
        Text(label, style: isTotal ? AppTypography.headingLarge : AppTypography.bodyLarge.copyWith(color: AppColors.textSecondary, fontSize: 18)),
        Text(value, style: isTotal ? AppTypography.headingLarge.copyWith(color: AppColors.primary) : AppTypography.bodyLarge.copyWith(fontSize: 18)),
      ],
    );
  }
}
