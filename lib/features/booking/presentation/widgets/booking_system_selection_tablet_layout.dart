  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final systems = [
      ...
      const SystemTypeModel(
        id: '2',
        name: 'Premium PC',
        description: 'RTX 4080, 32GB RAM, 240Hz',
        hourlyBaseRate: 10.0,
      ),
      const SystemTypeModel(
        id: '3',
        name: 'PS5 Lounge',
        description: 'PS5 with 4K TV and 2 controllers',
        hourlyBaseRate: 8.0,
      ),
      const SystemTypeModel(
        id: '4',
        name: 'VIP Room',
        description: 'Private room with 5 PCs for team plays',
        hourlyBaseRate: 25.0,
      ),
    ];
