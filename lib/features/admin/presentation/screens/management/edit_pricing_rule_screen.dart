...
class EditPricingRuleScreen extends StatefulWidget {
  const EditPricingRuleScreen({
    super.key,
    required this.id,
    this.name = 'Peak Hours',
    this.rate = '120',
    this.days = 'All days',
    this.timeWindow = 'Evening 6-10PM',
    this.systems = const ['All Systems'],
  });
  ...
  @override
  State<EditPricingRuleScreen> createState() => _EditPricingRuleScreenState();
}

class _EditPricingRuleScreenState extends State<EditPricingRuleScreen> {
  late final TextEditingController _nameController;
  late final TextEditingController _rateController;
  late String _selectedDays;
  ...
  void initState() {
    ...
    _selectedTimeWindow = widget.timeWindow;
    _selectedSystems = Set<String>.from(widget.systems);
  }
