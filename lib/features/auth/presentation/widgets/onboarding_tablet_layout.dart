...
final _onboardingTabletPageProvider = StateProvider.autoDispose<int>((ref) => 0);

class OnboardingTabletLayout extends ConsumerStatefulWidget {
  const OnboardingTabletLayout({super.key});

  @override
  ConsumerState<OnboardingTabletLayout> createState() =>
      _OnboardingTabletLayoutState();
}

class _OnboardingTabletLayoutState
    extends ConsumerState<OnboardingTabletLayout> {
  ...
  void _onPageChanged(int index) =>
      ref.read(_onboardingTabletPageProvider.notifier).state = index;

  @override
  Widget build(BuildContext context) {
    final currentPage = ref.watch(_onboardingTabletPageProvider);
    return SafeArea(
      child: Center(
