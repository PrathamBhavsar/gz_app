...
enum EmButtonVariant { primary, ghost, dangerOutline }
...
class EmButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (variant) {
      ...
      case EmButtonVariant.dangerOutline:
          ...
          child: Row(
            ...
            children: [
              if (loading)
                ...
                Text(
                  label,
                  style: AppTypography.button.copyWith(color: fg, fontSize: fontSize),
                ),
...
class EmButtonFull extends StatelessWidget {
  const EmButtonFull({
    super.key,
    required this.label,
    this.onPressed,
