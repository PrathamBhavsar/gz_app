...
type: Reference
title: Code Map
description: File and folder map of lib/ (core, models, shared, features). Update when .dart files move. Folded from the previous brain/code_map.md.
resource: file://lib
tags: [code-map, structure, files]
