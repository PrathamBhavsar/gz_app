---
type: Reference
title: UX Flow — 72-Screen Inventory
description: The exhaustive route -> screen -> API-target map for Player and Admin. Folded from the previous brain/features/ux_flow.md.
resource: file://lib/core/navigation/app_router.dart
tags: [ux, screens, routes, inventory]
timestamp: 2026-07-04
---
> Canonical full screen inventory. Per-feature summaries live in [modules/](../modules/index.md).
